...
<div class="home">
    ...
    <header class="section_wrap">
        <div class="header_wrap">
            <a href="./Hab/index.php" target="_blank"
            ><img class="img_width" src="img/logo.svg" alt="logo"
            /></a>
            <a href="./manager/index.php" target="_blank" class="btn_tg btn_hover_gradient">Войти с Telegram</a>
        </div>
    </header>
    ...
    <div class="contain ">
        <div class="" id="authors-list">
            ...
            <div class="adaptiv_comics_box comics_hide" id="adaptiv_block_3">
                <img class="img_width" src="img/adaptiv_2block.svg" alt="comics"/>
            </div>

            <div class="adaptiv_comics_box comics_hide" id="adaptiv_block_4">
                <img class="img_width" src="img/adaptiv_3block.svg" alt="comics"/>
            </div>

            <div class="adaptiv_comics_box comics_hide" id="adaptiv_block_5">
                <img class="img_width" src="img/adaptiv_4block.svg" alt="comics"/>
            </div>

            <div class="adaptiv_comics_box comics_hide" id="adaptiv_block_6">
                <img class="img_width" src="img/adaptiv_5block.svg" alt="comics"/>
            </div>

            <div class="adaptiv_comics_box comics_hide">
                <img class="img_width" src="img/adaptiv_6block.svg" alt="comics"/>
            </div>
        </div>
